            ...
            <div className="flex justify-between items-center bg-[#0D1117]">
                ...
                <div className="flex items-center gap-3">
                    <button disabled={isLoading}
                        className="disabled:opacity-50 disabled:cursor-not-allowed cursor-pointer border border-[#2a2a2a] rounded-[8px] px-3 py-2 text-[10px] tracking-[0.12em] text-[#9ca3af] transition-colors duration-150 hover:text-red-400 hover:border-red-400"
                        onClick={(event)=>{
